...
=== Generate GLTF API Sample

API samples that require GLTF forward-rendering functionalities can be generated using the following command:

[,bash]
----
./scripts/generate.py sample_api_gltf --name <SampleName> --category <category> --output-dir <output_dir>
----
...
[,cpp]
----
class SampleName :public GLTFApiVulkanSample {
...
};
----
