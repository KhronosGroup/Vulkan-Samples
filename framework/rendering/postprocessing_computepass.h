...
class PostProcessingComputePass : public PostProcessingPass<PostProcessingComputePass>
{
  public:
	...
	void prepare(vkb::core::CommandBufferC &command_buffer, vkb::rendering::RenderTargetC &default_render_target) override;
  ...
  private:
	 ...
	 */
	void transition_images(vkb::core::CommandBufferC &command_buffer, vkb::rendering::RenderTargetC &default_render_target);
