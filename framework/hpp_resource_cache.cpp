...
vkb::core::HPPPipelineLayout &HPPResourceCache::request_pipeline_layout(const std::vector<vkb::core::ShaderModule *> &shader_modules)
{
...
vkb::core::ShaderModule &HPPResourceCache::request_shader_module(vk::ShaderStageFlagBits            stage,
