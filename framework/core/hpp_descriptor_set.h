...
class HPPDescriptorSet : private vkb::DescriptorSet
{
  public:
	...
	HPPDescriptorSet(vkb::core::DeviceCpp &device, const vkb::core::HPPDescriptorSetLayout &descriptor_set_layout,
	                 vkb::core::HPPDescriptorPool &descriptor_pool, const BindingMap<vk::DescriptorBufferInfo> &buffer_infos = {},
	                 const BindingMap<vk::DescriptorImageInfo> &image_infos = {}) :
	    vkb::DescriptorSet(reinterpret_cast<vkb::core::DeviceC &>(device), reinterpret_cast<vkb::DescriptorSetLayout const &>(descriptor_set_layout),
	                       reinterpret_cast<vkb::DescriptorPool &>(descriptor_pool), reinterpret_cast<BindingMap<VkDescriptorBufferInfo> const &>(buffer_infos),
