...
namespace core
{
AccelerationStructure::AccelerationStructure(vkb::core::DeviceC &device, VkAccelerationStructureTypeKHR type) :
                                  ...
                                  VkBuildAccelerationStructureModeKHR  mode)
{
	...
	if (!buffer || buffer->get_size() != build_sizes_info.accelerationStructureSize)
	{
		...
		VkResult result                           = vkCreateAccelerationStructureKHR(
            device.get_handle(), &acceleration_structure_create_info, nullptr, &handle);
