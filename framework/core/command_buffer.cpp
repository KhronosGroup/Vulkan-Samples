...
void CommandBuffer::begin_render_pass(const RenderTarget                                                               &render_target,
                                      ...
                                      const std::vector<std::unique_ptr<vkb::rendering::Subpass<vkb::BindingType::C>>> &subpasses,
...
void CommandBuffer::bind_lighting(vkb::rendering::LightingState<vkb::BindingType::C> &lighting_state, uint32_t set, uint32_t binding)
{
