...
{
  public:
	HPPPipelineLayout(vkb::core::HPPDevice &device, const std::vector<vkb::core::ShaderModule *> &shader_modules);
	...
	ShaderResourceSet                                                get_resources(const vkb::core::ShaderResourceType &type  = vkb::core::ShaderResourceType::All,
	                                                                               vk::ShaderStageFlagBits              stage = vk::ShaderStageFlagBits::eAll) const;
	const std::vector<vkb::core::ShaderModule *>                    &get_shader_modules() const;
  ...
  private:
	...
	std::vector<vkb::core::ShaderModule *>                    shader_modules;                // The shader modules that this pipeline layout uses
