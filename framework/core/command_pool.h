...
vkb::core::CommandBuffer<bindingType> &CommandPool<bindingType>::request_command_buffer(CommandBufferLevelType level)
{
	...
	{
		return reinterpret_cast<vkb::core::CommandBufferC &>(CommandPoolBase::request_command_buffer(*reinterpret_cast<vkb::core::CommandPoolCpp *>(this), static_cast<vk::CommandBufferLevel>(level)));
	}
}
