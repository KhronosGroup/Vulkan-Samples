...
class DebugUtils
{
  public:
	 ...
	 */
	virtual void set_debug_name(VkDevice device, VkObjectType object_type, uint64_t object_handle, const char *name) const = 0;
	 ...
	 */
	virtual void cmd_begin_label(VkCommandBuffer command_buffer, const char *name, glm::vec4 color = {}) const = 0;
	 ...
	 */
	virtual void cmd_insert_label(VkCommandBuffer command_buffer, const char *name, glm::vec4 color = {}) const = 0;
};
...
class DummyDebugUtils final : public DebugUtils
{
  public:
	...
	inline void set_debug_tag(VkDevice, VkObjectType, uint64_t, uint64_t, const void *, size_t) const override
	{}

	inline void cmd_begin_label(VkCommandBuffer, const char *, glm::vec4) const override
	{}

	inline void cmd_end_label(VkCommandBuffer) const override
	{}

	inline void cmd_insert_label(VkCommandBuffer, const char *, glm::vec4) const override
	{}
};
...
{
  public:
	ScopedDebugLabel(const DebugUtils &debug_utils, VkCommandBuffer command_buffer, const char *name, glm::vec4 color = {});
