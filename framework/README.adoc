...
=== GLTF API sample base class

This base class is built on top of the API sample base class, with the addition of GLTF scene-loading functionalities. 

See link:./gltf_api_vulkan_sample.h[gltf_api_vulkan_sample.h] and link:./gltf_api_vulkan_sample.cpp[gltf_api_vulkan_sample.cpp].
