...
Please make sure you have VULKAN_SDK variable set in the system and pointing to your installation of Vulkan SDK.
____
...
Their versions are configured in the https://github.com/KhronosGroup/Vulkan-Samples/blob/master/bldsys/cmake/template/gradle/build.gradle.in[build.gradle.in] and https://github.com/KhronosGroup/Vulkan-Samples/blob/master/bldsys/cmake/template/gradle/app.build.gradle.in[app.build.gradle.in files];
...
* Find the configured versions in `build/android_gradle/app/build.gradle`, or its template file https://github.com/KhronosGroup/Vulkan-Samples/blob/master/bldsys/cmake/template/gradle/app.build.gradle.in[`bldsys/camke/template/gradle/app.build.gradle.in`]
