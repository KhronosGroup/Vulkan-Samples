...
void DescriptorIndexing::request_layer_settings(std::vector<VkLayerSettingEXT>                    &requested_layer_settings,
                                                vkb::StructureChainBuilderC<VkInstanceCreateInfo> &scb) const
{
	...
	requested_layer_settings.push_back(
	    {"MoltenVK", "MVK_CONFIG_USE_METAL_ARGUMENT_BUFFERS", VK_LAYER_SETTING_TYPE_INT32_EXT, 1, &scb.add_chain_data<int32_t>(1)});
}
#endif
