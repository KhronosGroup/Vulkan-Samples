...
/**
 * @brief Demonstrates how to use memory aliasing so that tensors and images use the same memory.
 *		  This enables the mixing of traditional compute and graphics operations with ML operations
 *        with no overhead from copying or format conversions.
...
#define TENSOR_IMAGE_ALIASING_RENDER_TO_ALIASED_IMAGE 0
	...
	std::unique_ptr<PipelineConstantTensor<int8_t>> weights_constant_tensor;
