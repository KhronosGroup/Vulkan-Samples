...
Portability::Portability() : pipelines(), pipeline_layouts(), descriptor_sets(), descriptor_set_layouts(), offscreen(), filter_pass()
{
	title = "Portability";
}
			...
			*/
			...
			if (display_skysphere)
			{
				...
				vkCmdBindDescriptorSets(
				    draw_cmd_buffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline_layouts.models, 0, 1, &descriptor_sets.skysphere, 0, nullptr);
