...
Shows how to use the ray tracing position fetch extension to directly access vertex positions for a hit triangle from the acceleration strucuture, instead of having to explicitly pass and unpack that information
