...
*Extensions*: https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VK_ARM_tensors.html[`VK_ARM_tensors`], https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VK_ARM_data_graph.html[`VK_ARM_data_graph`]
