...
-
////
ifndef::extenstion_samplespath[:extenstion_samplespath:]
...
=== xref:./{extenstion_samplespath}conservative_rasterization/README.adoc[Conservative Rasterization]
...
=== xref:./{extenstion_samplespath}dynamic_rendering/README.adoc[Dynamic Rendering]
...
=== xref:./{extenstion_samplespath}push_descriptors/README.adoc[Push Descriptors]
...
=== xref:./{extenstion_samplespath}debug_utils/README.adoc[Debug Utilities]
...
=== xref:./{extenstion_samplespath}memory_budget/README.adoc[Memory Budget]
...
=== xref:./{extenstion_samplespath}mesh_shader_culling/README.adoc[Mesh Shader Culling]
...
=== xref:./{extenstion_samplespath}ray_queries/README.adoc[Basic ray queries]
...
=== xref:./{extenstion_samplespath}ray_tracing_basic/README.adoc[Basic hardware accelerated ray tracing]
...
=== xref:./{extenstion_samplespath}ray_tracing_extended/README.adoc[Extended hardware accelerated ray tracing]
...
=== xref:./{extenstion_samplespath}mesh_shading/README.adoc[Mesh shading]
...
=== xref:./{extenstion_samplespath}hpp_mesh_shading/README.adoc[HPP Mesh shading]
...
=== xref:./{extenstion_samplespath}open_gl_interop/README.adoc[OpenGL interoperability]
...
=== xref:./{extenstion_samplespath}open_cl_interop/README.adoc[OpenCL interoperability]
...
=== xref:./{extenstion_samplespath}open_cl_interop_arm/README.adoc[OpenCL interoperability (Arm)]
...
=== xref:./{extenstion_samplespath}timeline_semaphore/README.adoc[Timeline semaphore]
...
=== xref:./{extenstion_samplespath}buffer_device_address/README.adoc[Buffer device address]
...
=== xref:./{extenstion_samplespath}synchronization_2/README.adoc[Synchronization2]
...
=== xref:./{extenstion_samplespath}descriptor_indexing/README.adoc[Descriptor indexing]
...
=== xref:./{extenstion_samplespath}fragment_shading_rate/README.adoc[Fragment shading rate]
...
=== xref:./{extenstion_samplespath}fragment_shading_rate_dynamic/README.adoc[Fragment shading rate_dynamic]
...
=== xref:./{extenstion_samplespath}ray_tracing_reflection/README.adoc[Ray tracing: reflection, shadow rays]
...
=== xref:./{extenstion_samplespath}portability/README.adoc[Portability]
...
=== xref:./{extenstion_samplespath}graphics_pipeline_library/README.adoc[Graphics pipeline library]
...
=== xref:./{extenstion_samplespath}conditional_rendering/README.adoc[Conditional rendering]
...
=== xref:./{extenstion_samplespath}vertex_dynamic_state/README.adoc[Vertex input dynamic state]
...
=== xref:./{extenstion_samplespath}extended_dynamic_state2/README.adoc[Extended dynamic state 2]
...
=== xref:./{extenstion_samplespath}logic_op_dynamic_state/README.adoc[Logic operations dynamic state]
...
=== xref:./{extenstion_samplespath}patch_control_points/README.adoc[Patch control points]
...
=== xref:./{extenstion_samplespath}fragment_shader_barycentric/README.adoc[Fragment shader barycentric]
...
=== xref:./{extenstion_samplespath}descriptor_buffer_basic/README.adoc[Basic descriptor buffer]
...
=== xref:./{extenstion_samplespath}color_write_enable/README.adoc[Color write enable]
...
=== xref:./{extenstion_samplespath}gshader_to_mshader/README.adoc[Geometry shader to mesh shader]
...
=== xref:./{extenstion_samplespath}shader_object/README.adoc[Shader object]
...
=== xref:./{extenstion_samplespath}dynamic_blending[Dynamic blending]
...
=== xref:./{extenstion_samplespath}dynamic_line_rasterization/README.adoc[Dynamic line rasterization]
