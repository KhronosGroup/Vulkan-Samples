...
-
////
ifndef::samplespath[:samplespath:]
...
=== xref:./{samplespath}conservative_rasterization/README.adoc[Conservative Rasterization]
...
=== xref:./{samplespath}dynamic_rendering/README.adoc[Dynamic Rendering]
...
=== xref:./{samplespath}push_descriptors/README.adoc[Push Descriptors]
...
=== xref:./{samplespath}debug_utils/README.adoc[Debug Utilities]
...
=== xref:./{samplespath}memory_budget/README.adoc[Memory Budget]
...
=== xref:./{samplespath}mesh_shader_culling/README.adoc[Mesh Shader Culling]
...
=== xref:./{samplespath}ray_queries/README.adoc[Basic ray queries]
...
=== xref:./{samplespath}mesh_shading/README.adoc[Mesh shading]
...
=== xref:./{samplespath}hpp_mesh_shading/README.adoc[HPP Mesh shading]
...
=== xref:./{samplespath}open_gl_interop/README.adoc[OpenGL interoperability]
...
=== xref:./{samplespath}open_cl_interop/README.adoc[OpenCL interoperability]
...
=== xref:./{samplespath}open_cl_interop_arm/README.adoc[OpenCL interoperability (Arm)]
...
=== xref:./{samplespath}timeline_semaphore/README.adoc[Timeline semaphore]
...
=== xref:./{samplespath}buffer_device_address/README.adoc[Buffer device address]
...
=== xref:./{samplespath}synchronization_2/README.adoc[Synchronization2]
...
=== xref:./{samplespath}descriptor_indexing/README.adoc[Descriptor indexing]
...
=== xref:./{samplespath}fragment_shading_rate/README.adoc[Fragment shading rate]
...
=== xref:./{samplespath}fragment_shading_rate_dynamic/README.adoc[Fragment shading rate_dynamic]
...
=== xref:./{samplespath}ray_tracing_reflection/README.adoc[Ray tracing: reflection, shadow rays]
...
=== xref:./{samplespath}portability/README.adoc[Portability]
...
=== xref:./{samplespath}graphics_pipeline_library/README.adoc[Graphics pipeline library]
...
=== xref:./{samplespath}conditional_rendering/README.adoc[Conditional rendering]
...
=== xref:./{samplespath}vertex_dynamic_state/README.adoc[Vertex input dynamic state]
...
=== xref:./{samplespath}extended_dynamic_state2/README.adoc[Extended dynamic state 2]
...
=== xref:./{samplespath}logic_op_dynamic_state/README.adoc[Logic operations dynamic state]
...
=== xref:./{samplespath}patch_control_points/README.adoc[Patch control points]
...
=== xref:./{samplespath}fragment_shader_barycentric/README.adoc[Fragment shader barycentric]
...
=== xref:./{samplespath}descriptor_buffer_basic/README.adoc[Basic descriptor buffer]
...
=== xref:./{samplespath}color_write_enable/README.adoc[Color write enable]
...
=== xref:./{samplespath}gshader_to_mshader/README.adoc[Geometry shader to mesh shader]
...
=== xref:./{samplespath}shader_object/README.adoc[Shader object]
...
=== xref:./{samplespath}dynamic_blending[Dynamic blending]
...
=== xref:./{samplespath}dynamic_line_rasterization/README.adoc[Dynamic line rasterization]
