...
void DynamicDepthClipping::build_command_buffers()
{
	...
	for (int32_t i = 0; i < draw_cmd_buffers.size(); ++i)
	{
		...
		// Enable depth clipping dynamically (if required)
		...
		// Turn the depth clipping off, so that it does not interfere with further rendering ( GUI rendering comes next )
...
void DynamicDepthClipping::load_assets()
{
...
void DynamicDepthClipping::setup_layouts()
{
