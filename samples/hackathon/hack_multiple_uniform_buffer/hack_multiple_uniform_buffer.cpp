...
void hack_multiple_uniform_buffer::draw(VkCommandBuffer &commandBuffer)
{
...
void hack_multiple_uniform_buffer::update_uniform_buffer()
{
	for (size_t i = 0; i < OBJECT_INSTANCES; i++)
	{
...
void hack_multiple_uniform_buffer::hack_render(VkCommandBuffer &commandBuffer)
{
	if (!paused)
	{
		update_uniform_buffer();
