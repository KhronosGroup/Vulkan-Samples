...
void hack_offset_uniform_buffer::build_command_buffers()
{
...
void hack_offset_uniform_buffer::update_uniform_buffer(float delta_time, bool force)
{
...
void hack_offset_uniform_buffer::hack_render(float delta_time)
{
	if (!paused)
	{
