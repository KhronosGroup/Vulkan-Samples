...
class Subpasses : public vkb::VulkanSample<vkb::BindingType::C>
{
  ...
  private:
	 ...
	 */
	void draw_subpasses(vkb::core::CommandBuffer<vkb::BindingType::C> &command_buffer, vkb::RenderTarget &render_target);

	/**
	 * @brief Draws using the bad practice: two separate render passes
	 */
	void draw_renderpasses(vkb::core::CommandBuffer<vkb::BindingType::C> &command_buffer, vkb::RenderTarget &render_target);
