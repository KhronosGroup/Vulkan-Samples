...
### [OpenCL interoperability](./extensions/open_cl_interop)<br/>
**Extensions**: [```VK_KHR_external_memory```](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VK_KHR_external_memory.html),[```VK_KHR_external_semaphore```](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VK_KHR_external_semaphore.html)<br/>
