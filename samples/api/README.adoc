...
=== xref:./{api_samplespath}swapchain_present_timing/README.adoc[Swapchain present timing]

A sample that demonstrates basic usage of presentation timing features.
