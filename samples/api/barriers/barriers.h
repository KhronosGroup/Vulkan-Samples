...
class Barriers : public ApiVulkanSample
{
  public:
	bool bloom          = true;
	...
	struct TestBarrierInfo
	{
		...
		bool                 enable             = true;
		bool                 enable_access_mask = true;
		bool                 enable_stage_mask  = true;
	};

	std::vector<TestBarrierInfo> test_barriers;
	...
	bool prepare_gui(vkb::Platform &platform) override;

	void conditional_image_memory_barrier(const std::string &title, const std::string &tooltip,
