...
=== link:./performance/afbc/README.adoc[AFBC]
...
=== link:./performance/command_buffer_usage/README.adoc[Command buffer usage]
...
=== link:./performance/constant_data/README.adoc[Constant data]
...
=== link:./performance/descriptor_management/README.adoc
...
=== link:./performance/hpp_swapchain_images/README.adoc[HPP Swapchain images]
...
=== link:./performance/layout_transitions/README.adoc[Layout transitions]
...
=== link:./performance/msaa/README.adoc[MSAA]
...
=== link:./performance/multithreading_render_passes/README.adoc[Multi-threaded recording with multiple render passes]
...
=== link:./performance/pipeline_barriers/README.adoc[Pipeline barriers]
...
=== link:./performance/pipeline_cache/README.adoc[Pipeline cache]
...
=== link:./performance/render_passes/README.adoc[Render passes]
...
=== link:./performance/specialization_constants/README.adoc[Specialization constants]
...
=== link:./performance/subpasses/README.adoc[Sub passes]
...
=== link:./performance/surface_rotation/README.adoc[Surface rotation]
...
=== link:./performance/swapchain_images/README.adoc[Swapchain images]
...
=== link:./performance/wait_idle/README.adoc[Wait idle]
...
=== link:./performance/16bit_storage_input_output/README.adoc[16-bit storage InputOutput]
...
=== link:./performance/16bit_arithmetic/README.adoc[16-bit arithmetic]
...
=== link:./performance/async_compute/README.adoc[Async compute]
...
=== link:./performance/texture_compression_basisu/README.adoc[Basis Universal supercompressed GPU textures]

This sample demonstrates how to use Basis universal supercompressed GPU textures in a Vulkan application.

=== link:./performance/multi_draw_indirect/README.adoc[GPU Rendering and Multi-Draw Indirect]

This sample demonstrates how to reduce CPU usage by offloading draw call generation and frustum culling to the GPU.

=== link:./performance/texture_compression_comparison/README.adoc[Texture compression comparison]
...
=== link:./api/compute_nbody/README.adoc[Compute shader N-Body simulation]

Compute shader example that uses two passes and shared compute shader memory for simulating a N-Body particle system.

=== link:./api/dynamic_uniform_buffers/README.adoc[Dynamic Uniform buffers]
...
=== link:./api/hpp_dynamic_uniform_buffers/README.adoc[HPP Dynamic Uniform Buffers]
...
=== link:./api/hpp_hdr/README.adoc[HPP High dynamic range]
...
=== link:./api/hpp_hello_triangle/README.adoc[HPP Hello Triangle]
...
=== link:./api/hpp_hlsl_shaders/README.adoc[HPP HLSL shaders]
...
=== link:./api/hpp_instancing/README.adoc[HPP Instancing]
...
=== link:./api/hpp_separate_image_sampler/README.adoc[HPP Separate image sampler]
...
=== link:./api/hpp_terrain_tessellation/README.adoc[HPP Terrain Tessellation]
...
=== link:./api/hpp_texture_loading/README.adoc[HPP Texture Loading]
...
=== link:./api/hpp_texture_mipmap_generation/README.adoc[HPP Texture run-time mip-map generation]
...
=== link:./api/hpp_timestamp_queries/README.adoc[HPP Timestamp queries]
...
=== link:./api/instancing/README.adoc[Instancing]
...
=== link:./api/separate_image_sampler/README.adoc[Separate image sampler]
...
=== link:./extensions/conservative_rasterization/README.adoc[Conservative Rasterization]
...
=== link:./extensions/dynamic_rendering/README.adoc[Dynamic Rendering]
...
=== link:./extensions/push_descriptors/README.adoc[Push Descriptors]
...
=== link:./extensions/debug_utils/README.adoc[Debug Utilities]
...
=== link:./extensions/memory_budget/README.adoc[Memory Budget]
...
=== link:./extensions/mesh_shader_culling/README.adoc[Mesh Shader Culling]
...
=== link:./extensions/ray_queries/README.adoc[Basic ray queries]
...
=== link:./extensions/raytracing_basic/README.adoc[Basic hardware accelerated ray tracing]
...
=== link:./extensions/raytracing_extended/README.adoc[Extended hardware accelerated ray tracing]
...
=== link:./extensions/mesh_shading/README.adoc[Mesh shading]
...
=== link:./extensions/open_gl_interop/README.adoc[OpenGL interoperability]
...
=== link:./extensions/open_cl_interop/README.adoc[Arm OpenCL interoperability]
...
=== link:./extensions/timeline_semaphore/README.adoc[Timeline semaphore]
...
=== link:./extensions/buffer_device_address/README.adoc[Buffer device address]
...
=== link:./extensions/synchronization_2/README.adoc[Synchronization2]
...
=== link:./extensions/descriptor_indexing/README.adoc[Descriptor indexing]
...
=== link:./extensions/fragment_shading_rate/README.adoc[Fragment shading rate]
...
=== link:./extensions/fragment_shading_rate_dynamic/README.adoc[Fragment shading rate_dynamic]
...
=== link:./extensions/ray_tracing_reflection/README.adoc[Ray tracing: reflection, shadow rays]
...
=== link:./extensions/portability/README.adoc[Portability]
...
=== link:./extensions/graphics_pipeline_library/README.adoc[Graphics pipeline library]
...
=== link:./extensions/conditional_rendering/README.adoc[Conditional rendering]
...
=== link:./extensions/vertex_dynamic_state/README.adoc[Vertex input dynamic state]
...
=== link:./extensions/extended_dynamic_state2/README.adoc[Extended dynamic state 2]
...
=== link:./extensions/logic_op_dynamic_state/README.adoc[Logic operations dynamic state]
...
=== link:./extensions/patch_control_points/README.adoc[Patch control points]
...
=== link:./extensions/fragment_shader_barycentric/README.adoc[Fragment shader barycentric]
...
=== link:./extensions/descriptor_buffer_basic/README.adoc[Basic descriptor buffer]
...
=== link:./extensions/color_write_enable/README.adoc[Color write enable]
...
=== link:./extensions/gshader_to_mshader/README.adoc[Geometry shader to mesh shader]
...
=== link:./extensions/shader_object/README.adoc[Shader object]
...
=== link:./extensions/dynamic_line_rasterization/README.adoc[Dynamic line rasterization]
...
=== link:./tooling/profiles/README.adoc[Profiles Library]
