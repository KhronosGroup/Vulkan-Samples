...
[source,cpp]
----
// T must be float or a plain struct of floats (e.g. glm::vec3, glm::vec4).
// The function assumes float component type; integer or normalized integer
