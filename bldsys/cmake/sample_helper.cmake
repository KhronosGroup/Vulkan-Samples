...
function(compile_shaders)
    ...
    if(NOT GLSLC_EXECUTABLE)
        message(FATAL_ERROR "glslc not found! Please set VULKAN_SDK to the Vulkan SDK path")
    endif()
    ...
    if(NOT DXC_EXECUTABLE)
        message(FATAL_ERROR "dxc not found! Please set VULKAN_SDK to the Vulkan SDK path")
    endif()
    ...
    foreach(SHADER_FILE_HLSL ${TARGET_SHADER_FILES_HLSL})
        ...
        message(WARNING "HLSL shaders are not supported yet")
