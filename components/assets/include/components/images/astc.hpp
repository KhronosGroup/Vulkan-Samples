...
class AstcCodec final : public ImageCodec
{
  public:
	...
	virtual void encode(const assets::ImageAsset &image, assets::ImageAssetPtr *o_image) const override;
	virtual void decode(const assets::ImageAsset &image, assets::ImageAssetPtr *o_image) const override;
};
}        // namespace images
}        // namespace components
