...
#include <components/vulkan/shaders/compiler.hpp>
...
class GlslangShaderCompiler : public vulkan::ShaderCompiler
{
  public:
	...
	std::vector<uint32_t> compile_spirv(const vulkan::CompilerConfig &config, const std::vector<uint8_t> &shader_source) const override;
